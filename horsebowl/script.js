...
//adds categories from JSON encoded js files
      // const categories = [jsonGeneral, jsonMovement, jsonMedical,
      //                     jsonAnatomy, jsonBreeds, jsonColor, jsonDevelopment];

let dataGeneral = JSON.parse(jsonGeneral);
let dataMovement = JSON.parse(jsonMovement);
let dataMedical = JSON.parse(jsonMedical);
let dataAnatomy = JSON.parse(jsonAnatomy);
let dataBreeds = JSON.parse(jsonBreeds);
let dataColor = JSON.parse(jsonColor);
let dataDevelopment = JSON.parse(jsonDevelopment);
